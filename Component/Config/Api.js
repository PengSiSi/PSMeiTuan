export default {
    ...
    menuInfo: [
            { title: '美食', icon: require('./../Images/Home/icon_homepage_foodCategory.png') },
            { title: '电影', icon: require('./../Images/Home/icon_homepage_movieCategory.png') },
            { title: '酒店', icon: require('./../Images/Home/icon_homepage_hotelCategory.png') },
            { title: 'KTV', icon: require('./../Images/Home/icon_homepage_KTVCategory.png') },
            { title: '优惠买单', icon: require('./../Images/Home/icon_homepage_default.png') },
            { title: '周边游', icon: require('./../Images/Home/icon_homepage_foottreatCategory.png') },
            { title: '生活服务', icon: require('./../Images/Home/icon_homepage_lifeServiceCategory.png') },
            { title: '休闲娱乐', icon: require('./../Images/Home/icon_homepage_entertainmentCategory.png') },
            { title: '丽人/美发', icon: require('./../Images/Home/icon_homepage_beautyCategory.png') },
            { title: '购物', icon: require('./../Images/Home/icon_homepage_shoppingCategory.png') },
